...
from reader.docqa import utils, vector, config, data
from reader.docqa import DocReader
...
def add_train_args(parser):
    ...
    general.add_argument('--char-embedding-dim', type=int, default=50,
                         help='embedding dim for character')
