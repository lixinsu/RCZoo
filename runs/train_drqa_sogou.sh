...
#
python3 scripts/reader/train_drqa.py --num-epochs 20 --embedding-file  sogou.full.embed  --data-dir data/sogou --restrict-vocab 0 --train-file  train_std-processed-jieba.txt --dev-file dev_std-processed-jieba.txt --dev-json dev_std.json --model-dir data/models --model-name drqa_sogou 
