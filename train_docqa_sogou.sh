...
#
python3 scripts/reader/train_docqa.py --num-epochs 40 --embedding-file  sogou.full.embed  --data-dir data/sogou --restrict-vocab 0 --train-file  train_std-processed-jieba.txt --dev-file dev_std-processed-jieba.txt --dev-json dev_std.json --model-dir data/models --model-name docqa_sogou 
